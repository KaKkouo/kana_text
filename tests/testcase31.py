...
testcase01i = [
    ...
    (kt('壱壱'), sb('5', kt('似似'), kt('')), '5', 'doc1', 'id-01', '分類子'),
    (kt('壱壱'), sb('5', kt(''), kt('')), '5', 'doc1', 'id-01', '分類子'),
    (kt('壱壱'), sb('5', kt('似似'), kt('参参')), '5', '', '', ''),
    (kt('壱壱'), sb('5', kt('似似'), kt('')), '5', '', '', ''),
    (kt('壱壱'), sb('5', kt(''), kt('')), '5', '', '', ''),
    (kt('いい|壱壱'), sb('5', kt(''), kt('')), '5', '', '', ''),
    (kt('いい|壱壱^'), sb('5', kt(''), kt('')), '5', '', '', ''),
    (kt('いい|壱壱^11'), sb('5', kt(''), kt('')), '5', '', '', ''),
]
